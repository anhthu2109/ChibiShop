...
import { decreaseAmount, increaseAmount, removeAllOrderProduct, removeOrderProduct, selectedOrder } from '../../redux/counter/orderSlide';
...
import StepComponet from '../../components/Steps/StepComponet';
...
const OrderPage = () => {
    ...
    const diliveryPriceMemo = useMemo(() => {
        if (priceMemo >= 150000 && priceMemo < 300000) {
            return 10000
    ...
    const itemsDelivery = [
        {
            title: '20.000 VND',
            description: 'Dưới 150.00 VND',
        },
        {
            title: '10.000 VND',
            description: 'Từ 150.000 VND đến dưới 300.000 VND',
        },
        {
            title: '0 VND',
    ...
    return (
        <div style={{ background: '#f5f5fa', width: '100%', height: '100%', paddingBottom: '200px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <WrapperLeft>
                        <WrapperStyleHeaderDelivery>
                            <StepComponet
                                items={itemsDelivery}
                                current={diliveryPriceMemo === 10000 ? 2 : diliveryPriceMemo === 20000 ? 1
